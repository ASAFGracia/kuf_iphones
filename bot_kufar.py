...
/profile - Показать свой профиль и статистику
...
• Цена ниже медианной более чем на 15% ИЛИ на 200 BYN
...
"""
        ...
        if is_admin:
            help_text += """
🔧 Админ команды:
/refresh - Пересчитать медианные цены
/parser_status - Статус работы парсера
/analytics - Аналитика проекта
/sql - SQL запросы к БД (интерактивный режим)
...
"""
        ...
        self.db.add_log(user_id, 'help', None, command='/help', source='kufar')
